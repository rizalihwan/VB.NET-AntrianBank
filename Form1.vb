Public Class Form1
    ...
    Private Sub audio()
       ...
       AudioPlayMode.WaitToComplete)
        My.Computer.Audio.Play(My.Resources.A_D,
       AudioPlayMode.WaitToComplete)
    End Sub
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        counter = Val(Form3.TextBox1.Text)
        Label2.Text = DateTimePicker1.Text
    End Sub
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        counter = counter + 1
        ComboBox1.Items.Clear()
        Label1.Text = Format(counter, "0 0 0")
        Form2.Label2.Text = Format(counter, "0 0 0")
        Dim b As String() = Label1.Text.Split(New Char() {" "c})
        Dim a As String
        For Each a In b
            ComboBox1.Items.Add(a)
        Next
        If Label1.Text = "0 9 9" Then
            counter = counter - 99
        End If
        If Label1.Text = tiket1.Label1.Text Then
            Button1.Hide()
        End If
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        sapi.speak("Panggilan Kepada Nomor  " & Label1.Text)
    End Sub
